...
- [How To Test](#Executing-the-tests)
...
In this section we can see our Navigation Diagrams
...
We can see the p¡age that could see a AdminUser
![](https://github.com/CodeURJC-DAW-2019-20/webapp3/blob/Fase-2/Annexed/screenshot/profile3.png)

We can see the p¡age that could see a BasicUser
