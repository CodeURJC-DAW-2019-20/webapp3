...
public class DatabaseLoader {
    ...
    private void initDatabase() throws IOException {
    	...
    	userRepository.save(new User("user", "pass","user lastname","user@swapit","C/ Buenavista 5","Mostoles","España","28358","619865541", 1000, true, "ROLE_USER"));
		
		//PRODUCTS
		productRepository.save(new Product("Sudadera Capucha", "Multi", "Jersey", "PullAndBear", "M", "", "",  true,true,true));
        productRepository.save(new Product("Jersey Mostaza", "Mostaza", "Jersey", "Zara", "S", "", "",  true,true,true));
        productRepository.save(new Product("Jersey Azul", "Azul", "Jersey", "Calvin Klein", "M", "", "",  true,true,true));
        productRepository.save(new Product("Jersey Burdeos", "Burdeos", "Jersey", "Zara", "M", "", "",  true,true,true));
        productRepository.save(new Product("Jersey Blanco", "Blanco", "Jersey", "HyM", "M", "", "",  true,true,true));
        productRepository.save(new Product("Jersey Gris", "Gris", "Jersey", "Primark", "M", "", "",  true,true,true));
        productRepository.save(new Product("Jersey Rosa", "Rosa", "Jersey", "Lefties", "M", "", "",  true,true,true));
        productRepository.save(new Product("Jersey A Rayas", "Multi", "Jersey", "Primark", "M", "", "",  true,true,true));
        productRepository.save(new Product("Camisa Pana", "Azul", "Camisa", "PullAndBear", "M", "", "",  true,true,true));
